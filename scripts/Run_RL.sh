...
# `ros2 launch --show-args` giờ chỉ còn launch_realsense + arg riêng của
# realsense2_camera. Muốn chỉnh mấy cái đó thì sửa thẳng YAML.
DEFAULT_ARGS=()
...
echo "[4/4] Source workspace overlay and launch ${LAUNCH_FILE} (perception_node + planner_motion_node + visualization_node)"
